...
public class OmegacarrotseedsPriShchielchkiePKMPoBlokuProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.FARMLAND && world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			world.setBlock(BlockPos.containing(x, y, z), MoeModBlocks.OMEGACARROT_1.get().defaultBlockState(), 3);
			if (!(new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(MoeModItems.OMEGACARROTSEEDS.get());
